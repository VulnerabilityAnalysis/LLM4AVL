...
def analyze_code_for_vulnerabilities(code_snippet):
    ...
    prompt = (f"You are a security expert who knows the locations of a software vulnerability. Now it is confirmed that there is a vulnerability in the following function:\n\n{code_with_lines}\n"
