...
# Assume the number of labels for the NER task
num_labels = 2  # Adjust based on your dataset (e.g., including 'O', 'B-LOC', and any other tags)
config = RobertaConfig(
    vocab_size=50265,  # Standard CodeBERT vocab size
