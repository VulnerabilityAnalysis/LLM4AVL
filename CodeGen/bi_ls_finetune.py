...
from modeling_codegen import BiCodeGenForTokenClassification
...
model = BiCodeGenForTokenClassification.from_pretrained(
...
trainer.train()
torch.save(model, "checkpoint/bi_full_model.pth")
