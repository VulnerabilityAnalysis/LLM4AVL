...
from modeling_codegen import FuCodeGenForTokenClassification
...
model = FuCodeGenForTokenClassification.from_pretrained(
...
trainer.train()
torch.save(model, "checkpoint/fu_last_model.pth")
