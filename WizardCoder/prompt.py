...
def analyze_code_for_vulnerabilities(code_snippet):
    ...
    prompt = (f"You are a security expert who knows the locations of a software vulnerability.\n### Instruction: Now it is confirmed that there is a vulnerability in the following function:\n\n{code_with_lines}\n"
...
max_code_tokens = 1968
id2label = {0: 'O', 1: 'B-LOC'}
with open('zs_wizardcoder_15b_sc.out', 'w') as res:
    true_labels = []
    true_predictions = []
